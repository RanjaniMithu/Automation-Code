package com.testflow.Add_Guvi_Library;
...
public class Add_Guvi_Library {
	...
	System.setProperty("webdriver.gecko.driver", "/home/guvi/Downloads/geckodriver");
        ...
        try {  
            ...
            fh = new FileHandler("/home/guvi/eclipse-workspace/TestFlow/src/com/testflow/Add_Guvi_Library/Message.log");  
		...
		Date date = new Date();
		ATUTestRecorder recorder=new ATUTestRecorder("/home/guvi/eclipse-workspace/TestFlow/ScriptVideos","Add_Guvi_Library-"+dateFormat.format(date),false);
		recorder.start();*/
        driver.manage().window().maximize();
        Thread.sleep(4000);
        //Read the UserInfo in JSON File
        String File="/home/guvi/eclipse-workspace/TestFlow/src/com/testflow/Add_Guvi_Library/UserInfo.json";
        ...
        driver.findElement(By.linkText("Add from GUVI Library")).click();
        Thread.sleep(4000);
        ...
        //Select the Group
        Select add=new Select(driver.findElement(By.id("group_title_selectguvi_1")));
