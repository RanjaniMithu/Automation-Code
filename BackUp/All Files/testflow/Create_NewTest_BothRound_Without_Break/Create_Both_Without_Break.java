package com.testflow.Create_NewTest_BothRound_Without_Break;
...
public class Create_Both_Without_Break {
    ...
    {			
		        ...
		        try {  
		            ...
		            fh = new FileHandler("/home/guvi/eclipse-workspace/TestFlow/src/com/testflow/Create_NewTest_BothRound_Without_Break/Message.log");  
			    ...
			    if(Typelength==7)
			    	if(Type.contains("Only Mcq Round")&&Type.contains("Only Programming Round")&&Type.contains("Only Summary Round")
			    		...
			    		&&Type.contains("Both Round With Break and Summary Test"))
				    	{
						    ...
						    TestType.selectByVisibleText("Both Round Without Break");
						    Thread.sleep(4000);
						    ...
						    Thread.sleep(4000);
						    driver.findElement(By.id("cut-off")).sendKeys("3");
						    Thread.sleep(4000);
			    ...
			    logger.info("Sucessfully Create the BothRound Without Break Test");
			    else
	...
	public static void main(String[] args) throws Exception {
	    ...
	    Date date = new Date();
	    ATUTestRecorder recorder=new ATUTestRecorder("/home/guvi/eclipse-workspace/TestFlow/ScriptVideos","Create_NewTest_BothRound_Without_Break-"+dateFormat.format(date),false);
	    recorder.start(); */
        driver.manage().window().maximize();
        //Read the UserInfo in JSON File
        String File="/home/guvi/eclipse-workspace/TestFlow/src/com/testflow/Create_NewTest_BothRound_Without_Break/UserInfo.json";
