package com.testflow.Create_NewTest_Summary;
...
public class Create_NewTest_Summary {
    ...
    {			
		        ...
		        try {  
		            ...
		            fh = new FileHandler("/home/guvi/eclipse-workspace/TestFlow/src/com/testflow/Create_NewTest_Summary/Message.log");  
			    ...
			    if(Typelength==7)
			    	if(Type.contains("Only Mcq Round")&&Type.contains("Only Programming Round")&&Type.contains("Only Summary Round")
			    		...
			    		&&Type.contains("Both Round With Break and Summary Test"))
				    	{
						    ...
						    TestType.selectByVisibleText("Only Summary Round");
						    Thread.sleep(4000);
						    driver.findElement(By.id("summary-time")).sendKeys("5");
						    Thread.sleep(4000);
			    ...
			    logger.info("Sucessfully Create the Summary Test");
			    }
	...
	public static void main(String[] args) throws Exception {
	    ...
	    Date date = new Date();
	    ATUTestRecorder recorder=new ATUTestRecorder("/home/guvi/eclipse-workspace/TestFlow/ScriptVideos","Create_NewTest_Summary-"+dateFormat.format(date),false);
	    recorder.start();*/ 
        driver.manage().window().maximize();
        //Read the UserInfo in JSON File
        String File="/home/guvi/eclipse-workspace/TestFlow/src/com/testflow/Create_NewTest_Summary/UserInfo.json";
